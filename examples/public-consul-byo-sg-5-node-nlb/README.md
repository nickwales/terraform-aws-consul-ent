...
| Name | Description |
|------|-------------|
| <a name="output_agent_asg_healthcheck_type"></a> [agent\_asg\_healthcheck\_type](#output\_agent\_asg\_healthcheck\_type) | Type of health check that is associated with the AWS autoscaling group. |
| <a name="output_agent_asg_name"></a> [agent\_asg\_name](#output\_agent\_asg\_name) | Name of the AWS autoscaling group that was created during the run. |
| <a name="output_agent_asg_target_group_arns"></a> [agent\_asg\_target\_group\_arns](#output\_agent\_asg\_target\_group\_arns) | List of the target group ARNs that are used for the AWS autoscaling group |
| <a name="output_agent_launch_template_name"></a> [agent\_launch\_template\_name](#output\_agent\_launch\_template\_name) | Name of the AWS launch template that was created during the run |
| <a name="output_agent_user_data_script"></a> [agent\_user\_data\_script](#output\_agent\_user\_data\_script) | base64 decoded user data script that is attached to the launch template |
